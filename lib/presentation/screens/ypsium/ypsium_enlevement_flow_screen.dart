...
class _YpsiumEnlevementFlowScreenState
  ...
  Widget _buildStepIndicator(AppColors colors) {
    const labels = ['Chargement', 'Photos', 'Validation'];
  ...
  Widget _buildStep2Photos(AppColors colors) {
    final order = widget.order;
    final hasRequired = order.photoEnlDebut || order.photoEnlFin;
    ...
    return Column(
      ...
      children: [
        ...
        // Info: photo integration requires image_picker
        Container(
          padding: const EdgeInsets.all(AppSpacing.md),
          decoration: BoxDecoration(
            color: colors.infoBg,
    ...
    return Column(
      ...
      children: [
        ...
        AppTextField(
          ...
          label: 'Nom du remettant',
          hint: 'Personne qui remet la marchandise',
